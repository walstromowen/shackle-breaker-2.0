...
export class AbilitiesPanel { 
    ...
    _drawAbilityCard(ab, abilityObj, x, y, w) { 
        ...
        const infoBlockHeight = hasStats ? 130 : 91; 
        const dividerHeight = descLines.length > 0 ? 48 : 0; 
        const descTextHeight = descLines.length > 0 ? (descLines.length * 29) : 0; 
        ...
        // Text Y-Anchors 
        const titleY = infoY + 29;   
        const sourceY = infoY + 67;  
        const statsY = infoY + 106;  
    ...
    _drawAbilityIcon(ability, x, y) { 
        ...
        if (sheet) { 
            ...
            this.ui.drawSprite( 
                ...
                iconData.row * 32, 
                32, 
                32, // Reading size stays same 
                x, 
                y, 
                this.ABILITY_ICON_SIZE, 
                this.ABILITY_ICON_SIZE // Draw size scaled up 
            ); 
        } else { 
