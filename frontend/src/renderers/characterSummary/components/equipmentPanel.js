...
// Adjusting path to reach src/shared from src/views/renderers/components/
...
export class EquipmentPanel {
    ...
    render(member, stats, activeSlots, selectedIndex, isChoosingItem, x, y, w, h, hitboxes) {
        ...
        // 4. Traits
        // Calculate Y based on portrait size or number of slots to avoid overlap
    ...
    _drawVitals(member, stats, centerX, y, fullX, fullW) {
        ...
        const gap = 15;
        // Measure total width to center the whole block
    ...
    _drawEquipmentLayout(member, activeSlots, selectedIndex, isChoosingItem, centerX, startY, w, hitboxes) {
        ...
        const drawSlot = (slotName, index, isLeft) => {
            ...
            // Calculate X based on side of portrait
            ...
            let nameY = slotY + 22;
            if (nameLines.length === 1) nameY += 4; // Vertically center single lines
        ...
        // Render Left column then Right column
    ...
    _drawTraitBadges(member, x, y, w, hitboxes) {
        ...
        traits.forEach(traitId => {
            ...
            // Wrap to next line if overflowing right edge
