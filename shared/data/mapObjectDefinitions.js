export const MAP_OBJECTS_DEFINITIONS = {
    ...
    WOODEN_CHEST: {
        spriteX: 0, spriteY: 5, width: 1, height: 1,
        isSolid: true, isGround: false, isAnchor: true,
        hitbox: { xOffset: 0, yOffset: 0, w: 1, h: 1 },
        interaction: { type: 'ENCOUNTER', id: 'WOODEN_CHEST_1', isRepeatable: false }
    },
    PINE_TREE: {
        spriteX: 3, spriteY: 1, width: 2, height: 2,
        isSolid: true, isGround: false, isAnchor: true,
        hitbox: { xOffset: 0, yOffset: 0, w: 2, h: 1 }
    },
    OAK_TREE_1: {
        spriteX: 0, spriteY: 1, width: 3, height: 3,
        isSolid: true, isGround: false, isAnchor: true,
    ...
    // --- ANIMATED ---
    CAMPFIRE: {
        spriteX: 0, spriteY: 6, frames: 4, speed: 0.2, width: 1, height: 1,
        isSolid: true, isGround: false, isAnchor: true,
        hitbox: { xOffset: 0, yOffset: 0, w: 1, h: 1 },
        interaction: { type: 'ENCOUNTER', id: 'bonfire' },
        light: {
            hasLight: true, radius: 5.5, color: '255, 100, 0',
            maxAlpha: 0.8, flickerSpeed: 0.1, flickerAmp: 0.5
        }
    }
};