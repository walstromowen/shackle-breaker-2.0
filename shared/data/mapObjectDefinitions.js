export const MAP_OBJECTS_DEFINITIONS = { 
  ...
  SMALL_ROCKS_3:    { spriteX: 10, spriteY: 0, width: 1, height: 1, isSolid: false, isGround: true }, // <-- NEW
  ...
  DESERT_SKULL:     { spriteX: 3, spriteY: 0, width: 1, height: 1, isSolid: false, isGround: true }, // <-- NEW
  ...
  ABANDONED_HOUSE_1: { 
    ...
    hitboxes: [ 
      { xOffset: 0, yOffset: 0, w: 1, h: 2 }, 
      { xOffset: 1, yOffset: -1, w: 1, h: 1 }, 
      { xOffset: 2, yOffset: -1, w: 2, h: 2 }  
    ] 
  }, 
  ...
  SMALL_CACTUS_1: { spriteX: 1, spriteY: 0, width: 1, height: 1, isSolid: true, isGround: false, isAnchor: true, hitbox: { xOffset: 0, yOffset: 0, w: 1, h: 1 } }, // <-- NEW
  SMALL_CACTUS_2: { spriteX: 2, spriteY: 0, width: 1, height: 1, isSolid: true, isGround: false, isAnchor: true, hitbox: { xOffset: 0, yOffset: 0, w: 1, h: 1 } }, // <-- NEW
  ...
  HOUSE_EXIT_DOOR: { 
    ...
    isSolid: false, isGround: false, isAnchor: true, 
    hitbox: { xOffset: 0, yOffset: 0, w: 1, h: 1 }, 
    interaction: { type: 'WARP', id: 'exit_interior' } 
  } 
};