 ...
 * Now includes explicit accuracy for all moves.
 */
...
export const AbilityDefinitions = {
    ...
    "punch": {
        ...
        cost: { stamina: 5 },
        accuracy: 0.95, // Standard reliable hit
        effects: [
    ...
    "bite": {
        ...
        targeting: { scope: "enemy", select: "single" },
        cost: { stamina: 10 },
        accuracy: 0.90, // Slightly less accurate than a punch
        effects: [
    ...
    "reckless_charge": {
        ...
        targeting: { scope: "enemy", select: "single" },
        cost: { stamina: 15 },
        accuracy: 0.80, // Low accuracy due to recklessness
        effects: [
            { 
                type: "damage", 
                element: "blunt", 
    ...
    "wild_swing": {
        ...
        cost: { stamina: 5 },
        accuracy: 0.70, // Very low accuracy
        effects: [
            { type: "damage", element: "blunt", power: 1.5 }
        ]
    },
    ...
    "baton_pass": {
        ...
        cost: { insight: 15 },
        speedModifier: 1.0,
        accuracy: 1.0, // Self-moves never miss
        effects: [
    ...
    "flurry": {
        ...
        targeting: { scope: "enemy", select: "single" },
        cost: { stamina: 25 },
        accuracy: 0.75, // Low accuracy per hit
    ...
    "solar_beam": {
        ...
        targeting: { scope: "enemy", select: "single" },
        cost: { insight: 15 }, 
        accuracy: 1.0, // Beams are hard to dodge
    ...
    "drain_life": {
        ...
        targeting: { scope: "enemy", select: "single" },
        cost: { insight: 15 },
        accuracy: 1.0, // Magical drain typically hits
        effects: [
    ...
    "intimidate": {
        ...
        targeting: { scope: "all_enemies", select: "auto" },
        cost: { stamina: 10 },
        accuracy: 1.0, // Shouts hit unless immune
        effects: [], 
        statusEffects: [
    ...
    "item_bear_trap": {
        ...
        targeting: { scope: "self", select: "auto" }, 
        speedModifier: 1.25,
        accuracy: 1.0, // Setting the trap always works
        statusEffects: [
