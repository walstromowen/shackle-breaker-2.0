...
export const ENTITY_DEFINITIONS = {
  ...
  "THUNDER_LOCUST": {
    ...
    attributes: { ...BEAST_TEMPLATE.attributes, vigor: 5, strength: 4, dexterity: 18, intelligence: 4, attunement: 16 },
    baseStats: {
      ...BEAST_TEMPLATE.baseStats,
  ...
  "POACHERS_NIGHTMARE": {
    ...
    level: 1, // Normalized down to Level 1
    frameSize: 192,
    ...
    attributes: { ...BEAST_TEMPLATE.attributes, vigor: 22, strength: 18, dexterity: 14, intelligence: 6, attunement: 8 },
    baseStats: {
      ...BEAST_TEMPLATE.baseStats,
  ...
  "DARIUS_THE_GROVELER": {
    ...
    attributes: {
      ...
      strength: 10,
      dexterity: 11,
      intelligence: 22, // Highly warped by the meteorite
      attunement: 18
    },
    baseStats: {
      ...HUMANOID_TEMPLATE.baseStats,
      ...
      baseDefense: {
        ...
        light: -4, // Weak to light, representing his dark cosmic corruption
        fire: -2
      },
