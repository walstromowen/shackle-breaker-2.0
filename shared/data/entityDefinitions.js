...
const BASE_ENTITY = {
    ...
    lootTableId: null, // <-- CHANGED from lootTable: []
    abilities: ["rest"],
    tags: ["ENTITY"]
};
...
export const ENTITY_DEFINITIONS = {
    ...
    "MAD_MAN": {
        ...
        battlePortraitFramesFront: 32, battlePortraitFramesBack: 1,
        crySound: "madmanCry", deathSound: "madmanCry",
    ...
    "MAD_MAGE": {
        ...HUMANOID_TEMPLATE,
        name: "Mad Mage", level: 1,
        spriteOverworld: "madMageSprite", spritePortrait: "madMagePortrait",
        battlePortraitFramesFront: 32, battlePortraitFramesBack: 32,
        crySound: "madMageCry", deathSound: "madMageCry",
        attributes: { ...HUMANOID_TEMPLATE.attributes, vigor: 6, intelligence: 14, attunement: 12 },
        baseStats: {
            ...HUMANOID_TEMPLATE.baseStats, maxHp: 20, maxStamina: 20, maxInsight: 20,
        ...
        lootTableId: "mad_mage_drops", // <-- CHANGED
        abilities: [...HUMANOID_TEMPLATE.abilities],
        tags: [...HUMANOID_TEMPLATE.tags]
    },
    "ROTTING_MAN": {
        ...HUMANOID_TEMPLATE,
        name: "Rotting Man", level: 1,
        spritePortrait: "rottingManPortrait",
        battlePortraitFramesFront: 29, battlePortraitFramesBack: 32,
        crySound: "madmanCry", deathSound: "madmanCry",
    ...
    "LEGIONARY": {
        ...HUMANOID_TEMPLATE,
        name: "Legionary", level: 1,
        spriteOverworld: "legionarySprite", spritePortrait: "legionaryPortrait",
        battlePortraitFramesFront: 32, battlePortraitFramesBack: 32,
        crySound: "legionaryCry", deathSound: "legionaryCry",
    ...
    "SAND_STALKER": {
        ...HUMANOID_TEMPLATE,
        name: "Sand Stalker", level: 1,
        spritePortrait: "sandStalkerPortrait",
        battlePortraitFramesFront: 32, battlePortraitFramesBack: 32,
        crySound: "sandStalkerCry", deathSound: "sandStalkerCry",
    ...
    "DOG": {
        ...
        baseStats: {
            ...BEAST_TEMPLATE.baseStats, maxHp: 12, maxStamina: 8, speed: 7, critical: 0.08,
            baseAttack: { blunt: 2, slash: 4, pierce: 2 }
        },
        lootTableId: "canine_drops", // <-- CHANGED
        abilities: [...BEAST_TEMPLATE.abilities],
        tags: [...BEAST_TEMPLATE.tags, "CANINE"]
    },
    "WOLF": {
        ...BEAST_TEMPLATE,
        name: "Grey Wolf", level: 1,
        spriteOverworld: "legionarySprite", spritePortrait: "wolfPortrait",
        battlePortraitFramesFront: 31, battlePortraitFramesBack: 32,
        crySound: "wolfCry", deathSound: "wolfCry",
        attributes: { ...BEAST_TEMPLATE.attributes, dexterity: 16, strength: 10 },
        baseStats: {
            ...BEAST_TEMPLATE.baseStats, maxHp: 28, maxStamina: 18, speed: 9, critical: 0.15,
    ...
    "SHACKLED_STEED": {
        ...BEAST_TEMPLATE,
        name: "Shackled Steed", level: 1,
        spriteOverworld: "shackledSteedSprite", spritePortrait: "shackledSteedPortrait",
        battlePortraitFramesFront: 25, battlePortraitFramesBack: 8,
        crySound: "shackledSteedCry", deathSound: "shackledSteedCry",
        attributes: { ...BEAST_TEMPLATE.attributes, vigor: 14, dexterity: 10, strength: 10 },
        baseStats: {
            ...BEAST_TEMPLATE.baseStats, maxHp: 40, maxStamina: 18, speed: 9, critical: 0.15,
            baseDefense: { ...BEAST_TEMPLATE.baseStats.baseDefense, ice: 4 },
            baseResistance: { ...BEAST_TEMPLATE.baseStats.baseResistance, fire: -0.25, ice: 0.25 },
    ...
    "AVIAN": {
        ...BASE_ENTITY,
        name: "Avian", spritePortrait: "hawkPortrait",
        ...
        baseStats: {
            ...BASE_ENTITY.baseStats, maxHp: 12, maxStamina: 15, maxInsight: 5, staminaRecovery: 3, speed: 10, critical: 0.15,
            baseDefense: { earth: 5 }, baseResistance: { wind: 0.5, earth: 0.2 },
