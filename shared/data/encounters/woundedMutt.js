            ...
            decisions: [
                {
                    ...
                    type: "skill_check", attribute: "attunement", threshold: 12,
                    customActionText: "{name} crushes the healing herb and carefully reaches toward the raw, bleeding leg...",
                    conditions: [{ type: "has_item", itemId: "healing_herb", qty: 1 }],
                    ...
                    failureOutcomes: [{ weight: 100, results: [{ type: "REMOVE_ITEM", payload: { itemId: "healing_herb", qty: 1 } }, { type: "ADVANCE_STAGE", payload: { stageId: "startled_mutt" } }] }]
                },
                {
                    text: "[DEX] Carefully dress and clean the raw wound with your bare hands.",
                    type: "skill_check", attribute: "dexterity", threshold: 15,
                    ...
                    failureOutcomes: [{ weight: 100, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "startled_mutt" } }] }]
                },
                {
