  ...
  stages: {
    ...
    "a_howl_in_the_dark": {
      ...
      decisions: [{
        ...
        // Kept direct enemy array: Enemy has modified starting HP and status effects
        outcomes: [{ weight: 100, results: [{ type: "START_BATTLE", payload: { enemies: [{ id: "MAD_MAN", startingHpPercent: 0.5, statusEffects: [{ id: "bleed", duration: 3, power: 5 }] }, "MAD_MAN"] } }] }]
      }]
    },
    "a_lucky_strike": {
    ...
    "enraged_lunatic": {
      ...
      decisions: [{
        text: "Draw your weapon!",
        // Kept direct enemy array: Enemy has modified starting HP
    ...
    "shattered_illusions": {
      ...
      decisions: [{
        ...
        outcomes: [{
          ...
          results: [
            { type: "MODIFY_VITALS", payload: { insight: 5 } },
            { type: "START_BATTLE", payload: { tableId: "madman_pack" } }
          ]
        }]
      }]
    }
