export const madmanAhead = {
    id: "madman_ahead",
    title: "Madman Ahead",
    imageSheet: "encounter_madman_ahead",
    initialStage: "a_disturbing_sight",
    stages: {
        // ==========================================
        // INITIAL DISCOVERY
        // ==========================================
        "a_disturbing_sight": {
            ...
            decisions: [
                ...
                },
                {
                    ...
                    failureOutcomes: [
                        { weight: 1, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "startled_prey" } }] },
                        { weight: 1, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "a_howl_in_the_dark" } }] }
                    ]
                },
                {
                    ...
                    failureOutcomes: [
                        { weight: 2, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "spotted" } }] },
                        { weight: 2, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "unnoticed_blunder" } }] },
                        { weight: 1, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "unintended_targets" } }] }
                    ]
                },
                {
                    ...
                    failureOutcomes: [
                        { weight: 100, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "descent_into_madness" } }] }
                    ]
                },
                { 
        ...
        "unnoticed_blunder": {
            ...
            decisions: [
                {
                    text: "Try again.",
                    outcomes: [{ weight: 100, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "a_disturbing_sight" } }] }]
                }
            ]
        },
        "unintended_targets": {
            ...
            decisions: [
                {
                    ...
                    failureOutcomes: [{ weight: 100, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "a_new_friend" } }] }]
                },
                {
                    ...
                    failureOutcomes: [{ weight: 100, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "rejected_by_the_magic" } }] }]
                },
                {
                    ...
                    failureOutcomes: [{ weight: 100, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "shattered_illusions" } }] }]
                }
            ]
        },
