            ...
            decisions: [
                {
                    ...
                    type: "skill_check", attribute: "strength", threshold: 8,
                    ...
                    failureOutcomes: [{ weight: 100, results: [{ type: "ADVANCE_STAGE", payload: { stageId: "chopped_fail" } }] }]
                },
                { text: "Leave.", customActionText: "{name} decides it is not worth the effort and walks away.", outcomes: [{ weight: 100, results: [{ type: "END_ENCOUNTER", payload: null }] }] },
