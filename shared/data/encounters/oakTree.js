      ...
      decisions: [
        {
          ...
          threshold: 8,
          conditions: [
            { type: "context_flag_not_set", flagId: "failed_oaktree_chop" },
          ...
          failureOutcomes: [
            { weight: 100, results: [{ type: "SET_CONTEXT_FLAG", payload: { flagId: "failed_oaktree_chop" } }, { type: "ADVANCE_STAGE", payload: { stageId: "chopped_fail" } }] }
          ]
        },
        {
          text: "Walk away.",
